...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        if(colorData){
            ...
            color = [UIColor colorWithRed:0.3f green:0.3f blue:1.0f alpha:.8f];
        }
...
- (void)update
{
    if(![_audioPlayer isKindOfClass:[AVAudioPlayer class]]) return;
    float scale = 0.5;
    if (((AVAudioPlayer*)_audioPlayer).playing )
    {
